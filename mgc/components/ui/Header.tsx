  ...
  return (
    ...
    >
      <nav className="flex items-center gap-4 sm:gap-8 px-6 sm:px-10 py-3 sm:py-3.5 rounded-full border border-white/10 glass-nav shadow-2xl">
        {["HOMEPAGE", "STORY", "PRIZEPOOL", "RECAP", "STAFF", "SPONSORED", "FAQ"].map((item) => {
          ...
          return (
            <a
              ...
              className="text-white font-poppins text-[10px] sm:text-[11px] lg:text-xs font-semibold tracking-[0.1em] sm:tracking-[0.12em] lg:tracking-[0.15em] transition-all duration-300 hover:text-primary hover:drop-shadow-[0_0_8px_rgba(249,115,22,0.6)]"
            >
              {item}
            </a>
          );
